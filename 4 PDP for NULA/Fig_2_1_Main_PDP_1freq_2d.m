...
character{4} = {'p_4'};
character{5} = {'p_5'};
text(P(:,1)+0.25,P(:,2)+0.2,character,'FontSize',16,'Color','r');
...
% highlight
highlight = [-90 -25 -26 -20 -21 0 20 26 25 90];
...
text(phase_wrapped(highlight+thetam+1,1)+0,phase_wrapped(highlight+thetam+1,2)-0.1,character,'FontSize',16);
...
text('position',[P(4,1)-0.8, P(4,2)-.2],'Interpreter','latex','String','{\boldmath$\Theta_4$}','FontSize',16,'Color','m');
