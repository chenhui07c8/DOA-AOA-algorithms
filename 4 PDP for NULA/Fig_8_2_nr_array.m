...
% S = [0 1 6 10 23 26]*lambda/5;
% S = [0 1 6 10 23 26 34 41]*lambda/5;
% S = [0 1 6]*lambda/5;
% S = [0 1 6 10 23]*lambda/5;
S = [0 1 6 10 23 26 34 41]*lambda/5;
...
%     ang_range = ones(1,50)*30;
    ang_range = doa_center + rand(10,1)-0.5;
...
%%
% save fig_8_2_data_3.mat;
% load fig_8_2_data_3.mat;


% save fig_8_2_data_5.mat;
% load fig_8_2_data_5.mat;


% save fig_8_2_data_8.mat;
